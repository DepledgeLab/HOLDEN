...
library(dplyr)
A_tx_filtered_9_DMSO <- NHDF_DMSO_48h_1.sup.allMods.trimAdapters.dorado.0.9.0.gencode_v47_probabilities %>% filter (code %in% c("-")& primary_base == "A")
m6A_tx_filtered_9_DMSO <- NHDF_DMSO_48h_1.sup.allMods.trimAdapters.dorado.0.9.0.gencode_v47_probabilities %>% filter (code %in% c("a")& primary_base == "A")
...
A_tx_filtered_9_STM <- NHDF_STM2457_48h_1.sup.allMods.trimAdapters.dorado.0.9.0.gencode_v47_probabilities %>% filter (code %in% c("-")& primary_base == "A")
m6A_tx_filtered_9_STM <- NHDF_STM2457_48h_1.sup.allMods.trimAdapters.dorado.0.9.0.gencode_v47_probabilities %>% filter (code %in% c("a")& primary_base == "A")
...
write.table(A_merged_df_9, "NHDF_DMSO_STM_A_tx&IVT_0.9.0_merged_df.txt", sep = "\t", row.names = FALSE)
write.table(m6A_merged_df_9, "NHDF_DMSO_STM_m6A_tx&IVT_0.9.0_merged_df.txt", sep = "\t", row.names = FALSE)
...
pdf(file = "A) A&m6A all-context in DMSO&STM in tx&IVT,0.9.0,Profile Plot.pdf", width = 20, height = 5)
combined_plot_9
dev.off()
...
#Generating the merged dataframe with ranges and fractions
library(dplyr)
A_tx_filtered_9_DMSO <- NHDF_DMSO_48h_1.sup.m6A_DRACH.trimAdapters.dorado.0.9.0_gencode_v47_probabilities %>% filter (code %in% c("-"))
m6A_tx_filtered_9_DMSO <- NHDF_DMSO_48h_1.sup.m6A_DRACH.trimAdapters.dorado.0.9.0_gencode_v47_probabilities %>% filter (code %in% c("a"))
...
A_tx_filtered_9_STM <- NHDF_STM2457_48h_1.sup.m6A_DRACH.trimAdapters.dorado.0.9.0_gencode_v47_probabilities %>% filter (code %in% c("-"))
m6A_tx_filtered_9_STM <- NHDF_STM2457_48h_1.sup.m6A_DRACH.trimAdapters.dorado.0.9.0_gencode_v47_probabilities %>% filter (code %in% c("a"))
...
write.table(A_merged_df_9, "NHDF_DMSO_STM_A_DRACH_tx&IVT_0.9.0_merged_df.txt", sep = "\t", row.names = FALSE)
write.table(m6A_merged_df_9, "NHDF_DMSO_STM_m6A_DRACH_tx&IVT_0.9.0_merged_df.txt", sep = "\t", row.names = FALSE)
...
pdf(file = "B) A&m6A(DRACH)in DMSO&STM in tx&IVT,0.9.0,Profile Plot.pdf", width = 20, height = 5)
combined_plot_9
dev.off()
...
#Generating the merged dataframe with ranges and fractions
library(dplyr)
U_tx_filtered_9_DMSO <- NHDF_DMSO_48h_1.sup.allMods.trimAdapters.dorado.0.9.0.gencode_v47_probabilities %>% filter (code %in% c("-")& primary_base == "T")
pseU_tx_filtered_9_DMSO <- NHDF_DMSO_48h_1.sup.allMods.trimAdapters.dorado.0.9.0.gencode_v47_probabilities %>% filter (code %in% c("17802")& primary_base == "T")
...
U_tx_filtered_9_STM <- NHDF_STM2457_48h_1.sup.allMods.trimAdapters.dorado.0.9.0.gencode_v47_probabilities %>% filter (code %in% c("-")& primary_base == "T")
pseU_tx_filtered_9_STM <- NHDF_STM2457_48h_1.sup.allMods.trimAdapters.dorado.0.9.0.gencode_v47_probabilities %>% filter (code %in% c("17802")& primary_base == "T")
...
write.table(U_merged_df_9, "NHDF_DMSO_STM_U_tx&IVT_0.9.0_merged_df.txt", sep = "\t", row.names = FALSE)
write.table(pseU_merged_df_9, "NHDF_DMSO_STM_pseU_tx&IVT_0.9.0_merged_df.txt", sep = "\t", row.names = FALSE)
...
pdf(file = "C) U&pseU in DMSO&STM in tx&IVT,0.9.0,Profile Plot.pdf", width = 20, height = 5)
combined_plot_9
dev.off()
...
library(dplyr)
A_tx_filtered_9_DMSO <- NHDF_DMSO_48h_1.sup.allMods.trimAdapters.dorado.0.9.0.gencode_v47_probabilities %>% filter (code %in% c("-")& primary_base == "A")
i_tx_filtered_9_DMSO <- NHDF_DMSO_48h_1.sup.allMods.trimAdapters.dorado.0.9.0.gencode_v47_probabilities %>% filter (code %in% c("17596")& primary_base == "A")
...
A_tx_filtered_9_STM <- NHDF_STM2457_48h_1.sup.allMods.trimAdapters.dorado.0.9.0.gencode_v47_probabilities %>% filter (code %in% c("-")& primary_base == "A")
i_tx_filtered_9_STM <- NHDF_STM2457_48h_1.sup.allMods.trimAdapters.dorado.0.9.0.gencode_v47_probabilities %>% filter (code %in% c("17596")& primary_base == "A")
...
#write.table(A_merged_df_9, "NHDF_DMSO_STM_A_tx&IVT_0.9.0_merged_df.txt", sep = "\t", row.names = FALSE)
write.table(i_merged_df_9, "NHDF_DMSO_STM_inosine_tx&IVT_0.9.0_merged_df.txt", sep = "\t", row.names = FALSE)
...
pdf(file = "D) A&inosine in DMSO&STM in tx&IVT,0.9.0,Profile Plot.pdf", width = 20, height = 5)
combined_plot_9
dev.off()
...
#Generating the merged dataframe with ranges and fractions
library(dplyr)
C_tx_filtered_9_DMSO <- NHDF_DMSO_48h_1.sup.allMods.trimAdapters.dorado.0.9.0.gencode_v47_probabilities %>% filter (code %in% c("-")& primary_base == "C")
m_tx_filtered_9_DMSO <- NHDF_DMSO_48h_1.sup.allMods.trimAdapters.dorado.0.9.0.gencode_v47_probabilities %>% filter (code %in% c("m")& primary_base == "C")
...
C_tx_filtered_9_STM <- NHDF_STM2457_48h_1.sup.allMods.trimAdapters.dorado.0.9.0.gencode_v47_probabilities %>% filter (code %in% c("-")& primary_base == "C")
m_tx_filtered_9_STM <- NHDF_STM2457_48h_1.sup.allMods.trimAdapters.dorado.0.9.0.gencode_v47_probabilities %>% filter (code %in% c("m")& primary_base == "C")
...
write.table(C_merged_df_9, "NHDF_DMSO_STM_C_tx&IVT_0.9.0_merged_df.txt", sep = "\t", row.names = FALSE)
write.table(m_merged_df_9, "NHDF_DMSO_STM_m_tx&IVT_0.9.0_merged_df.txt", sep = "\t", row.names = FALSE)
...
pdf(file = "E) C&m5C in DMSO&STM in tx&IVT,0.9.0,Profile Plot.pdf", width = 20, height = 5)
combined_plot_9
dev.off()
