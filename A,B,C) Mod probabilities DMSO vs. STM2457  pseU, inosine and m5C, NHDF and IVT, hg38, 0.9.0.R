...
library(dplyr)
U_hg38_filtered_9_DMSO <- NHDF_DMSO_48h_1.sup.allMods.trimAdapters.dorado.0.9.0_hg38_probabilities %>% filter (code %in% c("-")& primary_base == "T")
pseU_hg38_filtered_9_DMSO <- NHDF_DMSO_48h_1.sup.allMods.trimAdapters.dorado.0.9.0_hg38_probabilities %>% filter (code %in% c("17802")& primary_base == "T")
...
U_hg38_filtered_9_STM <- NHDF_STM2457_48h_1.sup.allMods.trimAdapters.dorado.0.9.0_hg38_probabilities %>% filter (code %in% c("-")& primary_base == "T")
pseU_hg38_filtered_9_STM <- NHDF_STM2457_48h_1.sup.allMods.trimAdapters.dorado.0.9.0_hg38_probabilities %>% filter (code %in% c("17802")& primary_base == "T")
...
write.table(U_merged_df_9, "NHDF_DMSO_STM_U_hg38&IVT_0.9.0_merged_df.txt", sep = "\t", row.names = FALSE)
write.table(pseU_merged_df_9, "NHDF_DMSO_STM_pseU_hg38&IVT_0.9.0_merged_df.txt", sep = "\t", row.names = FALSE)
...
pdf(file = "A) U&pseU in DMSO&STM in hg38&IVT,0.9.0,Profile Plot.pdf", width = 20, height = 5)
combined_plot_9
dev.off()
...
i_hg38_filtered_9_DMSO <- NHDF_DMSO_48h_1.sup.allMods.trimAdapters.dorado.0.9.0_hg38_probabilities %>% filter (code %in% c("17596")& primary_base == "A")
...
i_hg38_filtered_9_STM <- NHDF_STM2457_48h_1.sup.allMods.trimAdapters.dorado.0.9.0_hg38_probabilities %>% filter (code %in% c("17596")& primary_base == "A")
...
write.table(i_merged_df_9, "NHDF_DMSO_STM_inosine_hg38&IVT_0.9.0_merged_df.txt", sep = "\t", row.names = FALSE)
...
pdf(file = "B) A&inosine in DMSO&STM in hg38&IVT,0.9.0,Profile Plot.pdf", width = 20, height = 5)
combined_plot_9
dev.off()
...
#Generating the merged dataframe with ranges and fractions
library(dplyr)
C_hg38_filtered_9_DMSO <- NHDF_DMSO_48h_1.sup.allMods.trimAdapters.dorado.0.9.0_hg38_probabilities %>% filter (code %in% c("-")& primary_base == "C")
m_hg38_filtered_9_DMSO <- NHDF_DMSO_48h_1.sup.allMods.trimAdapters.dorado.0.9.0_hg38_probabilities %>% filter (code %in% c("m")& primary_base == "C")
...
C_hg38_filtered_9_STM <- NHDF_STM2457_48h_1.sup.allMods.trimAdapters.dorado.0.9.0_hg38_probabilities %>% filter (code %in% c("-")& primary_base == "C")
m_hg38_filtered_9_STM <- NHDF_STM2457_48h_1.sup.allMods.trimAdapters.dorado.0.9.0_hg38_probabilities %>% filter (code %in% c("m")& primary_base == "C")
...
write.table(C_merged_df_9, "NHDF_DMSO_STM_C_hg38&IVT_0.9.0_merged_df.txt", sep = "\t", row.names = FALSE)
write.table(m_merged_df_9, "NHDF_DMSO_STM_m_hg38&IVT_0.9.0_merged_df.txt", sep = "\t", row.names = FALSE)
...
pdf(file = "C) C&m5C in DMSO&STM in hg38&IVT,0.9.0,Profile Plot.pdf", width = 20, height = 5)
combined_plot_9
dev.off()
